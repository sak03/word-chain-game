...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms for playing Word Chain Challenge safely and fairly.",
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      title="Terms of Use"
      intro="These simple terms help keep Word Chain Challenge safe, fair, and fun for everyone."
      sections={[
        { title: "Using the game", content: <p>Word Chain Challenge is a free educational word game. You may use it for personal, family, or classroom play. Please do not misuse the service, attempt to disrupt it, or use automated tools to overload its word APIs.</p> },
